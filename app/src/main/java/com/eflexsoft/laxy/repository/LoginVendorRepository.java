...
public class LoginVendorRepository {

    Context context;
    public MutableLiveData<Boolean> isSignInSuccessful = new MutableLiveData<>();

    public LoginVendorRepository(Context context) {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (isUserNew) {
                        ...
                        DocumentReference documentReference = firebaseFirestore.collection("Vendors").document(id);
